...
`/workspaces/MetrAIyux-0S/Skye-Clients/empire-pallets-v3-app`
...
- Added a gated full-screen intro sequence that uses the supplied Empire Pallets MP4 as atmosphere while keeping app surfaces hidden and inert until release.
- Generated and wired `/assets/empire-pallets-logo-transparent.png` so the supplied logo no longer renders with the checkerboard box.
...
- Added GSAP, ScrollTrigger, Lenis, import maps, package metadata, living canvas, motion chrome, text effects, and scroll-stage source for the MCP stack contract.
...
- Verified the intro hides and locks app surfaces on desktop and mobile: `appSurfaceVisibleWhileIntro: false`, `appSurfaceLockedWhileIntro: true`.
...
- Current gated local proof JSON: `/workspaces/MetrAIyux-0S/test-artifacts/empire-pallets-v3-app/gated-intro-proof-final-2/final-proof.json`
...
- Final gated app proof runner: `BASE_URL=http://127.0.0.1:4220 ARTIFACT_DIR=/workspaces/MetrAIyux-0S/test-artifacts/empire-pallets-v3-app/gated-intro-proof-final-2 node tests/final-proof.mjs`
- Live app proof runner: `BASE_URL=https://empire-pallets.pages.dev ARTIFACT_DIR=/workspaces/MetrAIyux-0S/test-artifacts/empire-pallets-v3-app/live-proof node tests/final-proof.mjs`
- Live Cloudflare Pages URL: `https://empire-pallets.pages.dev/`
- Live QR target: `https://empire-pallets.pages.dev/scan`
- Cloudflare Pages project: `empire-pallets`
