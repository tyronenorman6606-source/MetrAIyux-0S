...
```bash
npm run mcp:mine -- /workspaces/MetrAIyux-0S/Skye-Clients/empire-pallets-v3-app
```
...
```text
https://empire-pallets.pages.dev/scan
```

Production proof:

```bash
BASE_URL=https://empire-pallets.pages.dev ARTIFACT_DIR=/workspaces/MetrAIyux-0S/test-artifacts/empire-pallets-v3-app/live-proof node tests/final-proof.mjs
```
