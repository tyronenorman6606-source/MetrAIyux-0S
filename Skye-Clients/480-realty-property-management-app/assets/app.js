...
const CLIENT_APP_INTAKE={sourceApp:'480-realty-property-management',workspaceId:'480-realty-property-management-preview-001',businessName:'480 Realty & Property Management',endpoint:'https://skyegatefs27-citadeldb.graylondonskyes.workers.dev/.netlify/functions/client-app-intake',successMessage:'Request received. It is now in the 480 Realty 0S lead lane for workspace review.'};
