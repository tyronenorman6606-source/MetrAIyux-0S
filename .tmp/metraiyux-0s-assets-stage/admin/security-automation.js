const SecurityAutomation = (() => {
  ...
  async function setupMfa() {
    ...
    $('mfaSetupResult').innerHTML = `<div>${data.qr_svg}</div><p><b>Device:</b> ${esc(data.device.id)}</p><p><a class="button" href="../Free99/apps/skyebox-authenticator/index.html">Open SkyeBox Authenticator</a></p><textarea readonly>${esc(data.otpauth_uri)}</textarea>`;
  }
