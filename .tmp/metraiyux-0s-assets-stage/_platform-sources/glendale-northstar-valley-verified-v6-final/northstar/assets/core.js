(function (root, factory) {
  ...
  const DEFAULT_STATE = Object.freeze({
    ...
    workspace: {
      ...
      name: 'NorthStar Local Workspace',
      role: 'operator'
    },
    settings: {
      logo: './assets/brand/signinpro-northstar-skye-tiger-logo.png',
      eventName: 'SignInPro Guest Access',
      idLabel: 'Event ID',
      enableSound: true,
      allowDuplicateEmails: false,
      retentionNote: 'Workspace records are scoped to this company and backed up when the NorthStar connection is active. Export backups before clearing browser data.',
      syncEnabled: true
    },
    attendees: [],
    audit: []
  ...
  function sanitizeWorkspace(workspace) {
    ...
    return {
      ...
      name: safeText(raw.name, 160) || 'NorthStar Local Workspace',
  ...
  function buildBackup(state) {
    ...
    return {
      product: 'SignInPro Executive Edition',
