...
const clientBuilds = [
  {
    ...
    proof:[['Build source','Skye-Clients/bobs-smoke-shop-mcp-redo'],['Live build URL','https://bobs-smoke-shop.pages.dev/'],['Valley route','/business/bobs-smoke-shop-litchfield-park/']]
  },
  {
    id:'empire',
    name:'Empire Pallets',
...
function websiteHero(){ return `<section class="hero website-hero editorial-atlas"><div class="hero-copy"><p class="eyebrow">Arizona verified business network</p><h1 class="neon-gradient-text text-highlighter text-effect-reveal">Valley Verified gives the public post. The app-build lane shows what a business can buy after approval.</h1><p class="hero-text">Valley Verified turns local records and customer submissions into useful public landing pages, then connects qualified businesses to app builds when they need buyer actions, quote flows, media, QR routes, and proof-backed handoff.</p><div class="hero-actions"><a class="btn primary" href="/directory/">Explore the marketplace</a><a class="btn" href="/app-builds/">See live client builds</a><a class="btn ghost" href="${APP_BUILD_GATE_HREF}" target="_blank" rel="noopener">SkyePay gate offer</a><a class="btn ghost" href="/for-businesses/">Claim or improve a profile</a></div></div><aside class="atlas-panel"><p class="eyebrow">Network receipt</p><div class="hero-card website-metrics">${metric(currency(count),'business pages')}${metric(currency(categoryCount),'service lanes')}${metric(currency(cityCount),'Arizona markets')}${metric(currency(report.records?.exact_merges ?? 0),'duplicate records merged')}</div><div class="atlas-list"><div><strong>A free public business page as our gift</strong><span>Qualified MetrAIyux 0S customers get one public business posting after their first paid month.</span></div><div><strong>App-build lane</strong><span>Bob's, Empire, Next Level, Fade Masters, 480 Realty, Dink & Dine, Techbros, and ArcLight show inspectable upgrade examples with owner-approved production proof.</span></div></div></aside></section>`; }
