...
const DEFAULT_CONFIG = {
  brandName: "MetrAIyux 0S",
  kicker: "Interactive route map",
  subtitle: "MetrAIyux 0S app lanes, company knowledge, gates, proof, payments, client surfaces, and Valley Verified routes.",
  coreLogo: "assets/metraiyux-0s-emblem-transparent.png",
  homeHref: "ecosystem.html",
  focusNode: "company-knowledge",
  selfUrl: "https://metraiyux-0s-full-system.graylondonskyes.workers.dev/ecosystem.html",
  partnerUrl: "https://metraiyux-0s-full-system.graylondonskyes.workers.dev/live/company-knowledge-layer-proof.html",
  primaryCta: "Open Company Knowledge"
};
...
const nodes = [
  {
    ...
    routes: [
      ...
      { label: "Company Knowledge Proof", url: `${zeroBase}/live/company-knowledge-layer-proof.html` },
  ...
  },
  {
    ...
    summary: "Cloudflare R2/KV company memory layer for founder-owned 0S knowledge and tenant-scoped SaaS company knowledge.",
    tags: ["knowledge", "memory", "cloudflare", "r2", "kv", "saas", "proof"],
    routes: [
      { label: "Proof room", url: `${zeroBase}/live/company-knowledge-layer-proof.html` },
      { label: "Owner console", url: `${zeroBase}/admin/company-knowledge.html` },
      { label: "SaaS console", url: `${zeroBase}/saas/company-knowledge.html` },
      { label: "Stress JSON", url: `${zeroBase}/proof/live-company-knowledge-stress-latest.json` }
    ]
  },
  {
    id: "client",
  ...
  },
  {
    ...
    summary: "Music operating surface with DAW creation, drops, listener discovery, feed, rights, exchange proof, and creative app routes.",
    tags: ["music", "studio", "nexus", "creative", "daw", "drops", "discover", "feed"],
    routes: [
      { label: "Music proof", url: `${zeroBase}/live/skyemusicnexus-neofront.html` },
      { label: "Music app", url: `${zeroBase}/SkyeMusicNexus/index.html` },
      { label: "DAW", url: `${zeroBase}/SkyeMusicNexus/public/daw.html` },
      { label: "Drops", url: `${zeroBase}/SkyeMusicNexus/public/drops.html` },
      { label: "Discover", url: `${zeroBase}/SkyeMusicNexus/public/discover.html` },
      { label: "Feed", url: `${zeroBase}/SkyeMusicNexus/public/feed.html` },
  ...
  },
  {
    ...
    x: -430,
    y: -505,
    label: "Free99 Platform Intake",
    summary: "Mounted intake hub for 11 imported platform apps: SkyeOpsConsole as the only no-charge app, plus SovereignDocs and paid/gated platform lanes under the 0S gate, platform_id tags, and usage_lane boundaries.",
    tags: ["free99", "intake", "platform", "proof", "skyeopsconsole", "sovereigndocs", "paid apps", "platform_id", "usage_lane", "changelog"],
    routes: [
      { label: "Free99 hub", url: `${zeroBase}/Free99/index.html` },
      { label: "SkyeOpsConsole Free99", url: `${zeroBase}/Free99/apps/skyeopsconsole/index.html` },
      { label: "SovereignDocs", url: `${zeroBase}/Free99/apps/sovereigndocs/index.html` },
      { label: "SovereignDocs library", url: `${zeroBase}/Free99/apps/sovereigndocs/documents/index.html` },
      { label: "Free99 receipt", url: `${zeroBase}/proof/free99-platform-intake-receipt.html` },
      { label: "Feature Atlas entry", url: `${zeroBase}/feature-atlas.html#app-lanes` },
      { label: "Changelog entry", url: `${zeroBase}/changelog/index.html#free99-platform-intake` }
    ]
  },
  {
    id: "skyemerit",
...
const links = [
  ...
  ["proof-router", "company-knowledge"],
  ...
  ["connectlog", "client"],
  ["admin", "kaixu"],
  ["admin", "company-knowledge"],
  ["admin", "skyeroutex"],
  ["client", "saas"],
  ["client", "free99"],
  ["free99", "feature-atlas"],
  ["free99", "skygate"],
  ["free99", "skyepay"],
  ["skyeroutex", "profit"],
  ["profit", "split"],
...
const state = {
  ...
  filter: "all",
  query: "",
  selected: cfg.focusNode || "company-knowledge",
