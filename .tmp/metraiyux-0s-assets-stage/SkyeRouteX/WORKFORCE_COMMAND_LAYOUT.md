...
Do not recreate a root-level v0.4.0 RouteX folder inside `metraiyux_0s_site`. That would split the command shell from the workforce app again and reintroduce a deployable duplicate.
