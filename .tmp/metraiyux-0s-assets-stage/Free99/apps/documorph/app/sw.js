/* DocuMorph PWA Service Worker. 0S gate-owned pages are network-first. */
const CACHE_NAME = "documorph-pwa-v3";
...
// Network-first for GET. Network-only for non-GET.
  ...
  if (req.mode === "navigate") {
    event.respondWith((async () => {
      ...
      try {
        ...
        if (fresh && fresh.ok && !fresh.redirected && fresh.type === "basic") cache.put(req, fresh.clone());
        return fresh;
      } catch {
