# Cursor task: integrate SkyeAPI into this repo
...
Cursor-specific instruction: use repo-wide search for provider SDK imports, replace carefully, and preserve UI/UX. Add comments only where they help future maintenance.
