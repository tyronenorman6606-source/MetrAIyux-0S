# Client Command Deck Rebrand Upgrade Manifest

Generated: 2026-05-15T11:31:56+00:00

## What changed

- Locked the official product name to **Client Command Deck**.
...
- Added `docs/CLIENT_COMMAND_DECK_PLATFORM_IDENTITY.md`.
- Added `docs/CLIENT_COMMAND_DECK_REBRAND_MANIFEST.md`.
- Added admin tutorial lesson 28: Client Command Deck Brand Lock.
- Updated valuation language and package docs.
- Updated the brain registry platform metadata.
- Added Client Command Deck brand documents into the local brain knowledge base.
