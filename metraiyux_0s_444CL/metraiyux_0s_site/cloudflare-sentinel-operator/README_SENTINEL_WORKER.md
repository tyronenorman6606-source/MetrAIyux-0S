...
This Worker adds a lightweight API for the Site Operator Brain. It can route business signals, create tasks, store receipts in KV, write structured records to D1, and enqueue async work.
