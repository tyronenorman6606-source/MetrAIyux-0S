...
const defaults = {
  ...
  supportEmailValue: '',
  publicHeadlineValue: 'I built SkyeVault-Drop so client files, media, and repo snapshots stop drifting through inboxes and land in one receipt-backed vault.',
  publicSubheadlineValue: 'The surface beside this copy is the actual intake room: add context, send the package, and keep the proof receipts clean. I route files through routing gates into Cloudflare R2, write the ledger receipt, and review the archive from the operator side.',
  publicInstructionsValue: 'Add the project details, attach the files or sanitized repo zip, confirm permission, and keep this page open until every file says complete.',
  retentionNoticeValue: 'Uploaded files are used for intake, production, review, delivery, and proof. Tell your project contact before sending anything that needs special handling.',
...
function buildVaultConfig(state) {
  return {
    ...
    publicHeadline: state.publicHeadlineValue || 'I built SkyeVault-Drop so client files, media, and repo snapshots stop drifting through inboxes and land in one receipt-backed vault.',
    publicSubheadline: state.publicSubheadlineValue || 'The surface beside this copy is the actual intake room: add context, send the package, and keep the proof receipts clean. I route files through routing gates into Cloudflare R2, write the ledger receipt, and review the archive from the operator side.',
    publicInstructions: state.publicInstructionsValue || 'Add the project details, attach the files or sanitized repo zip, confirm permission, and keep this page open until every file says complete.',
    retentionNotice: state.retentionNoticeValue || 'Uploaded files are used for intake, production, review, delivery, and proof. Tell your project contact before sending anything that needs special handling.',
