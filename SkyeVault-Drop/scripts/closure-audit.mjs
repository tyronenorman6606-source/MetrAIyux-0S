...
const checks = [
  ...
  ['browser prevents duplicate re-upload after storage success', files.app.includes('PENDING_FINALIZATION_KEY') && files.app.includes('noFallback') && files.index.includes('Receipt recovery')],
  ['pending receipt retry is implemented', files.app.includes('retryPendingFinalizations') && files.index.includes('retryPending')],
  ...
  ['client pause/resume control exists', files.index.includes('pauseUpload') && files.app.includes('AbortController') && files.app.includes('error.paused')],
  ['client receipt export exists', files.index.includes('downloadReceipts') && files.app.includes('receiptExportPayload')],
  ...
  ['honeypot and Turnstile controls exist', files.rateLimit.includes('assertHoneypot') && files.rateLimit.includes('verifyTurnstile') && files.index.includes('companyWebsite') && files.app.includes('turnstileToken')],
  ...
  ['public page explains repo snapshot lane', files.index.includes('repo-snapshots') && files.index.includes('npm run vault:push')],
