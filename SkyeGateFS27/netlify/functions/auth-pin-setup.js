...
export default wrap(async (req) => {
  ...
  return json(200, {
    ...
    recovery_notice: delivery.delivered
      ? "Recovery codes were sent through the configured email webhook and are returned once in this setup response."
      : "No AUTH_EMAIL_WEBHOOK_URL is configured, so this is preview mode. Store the returned codes now."
  }, cors);
});
