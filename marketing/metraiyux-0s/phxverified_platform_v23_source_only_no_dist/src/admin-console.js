...
function readHeaders(){
  const roles = $('upstream-roles')?.value || 'admin ae owner buyer';
  return {
    'content-type':'application/json',
    'x-upstream-user-id':$('upstream-user-id')?.value || '',
    'x-upstream-user-email':$('upstream-email')?.value || '',
    'x-upstream-roles':roles
  };
}
