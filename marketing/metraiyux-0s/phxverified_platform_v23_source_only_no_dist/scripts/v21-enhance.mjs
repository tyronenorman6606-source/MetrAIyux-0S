...
function landingBlueprint(b){
  ...
  if(isBob){
    return {
      eyebrow:'Featured Litchfield Park smoke shop page',
      headline:"Bob's Smoke Shop landing page",
      copy:"A one-page Valley Verified landing built from Bob's live shop app: 21+ retail context, glass, vapes, cigars, pipes, CBD, tobacco, hookah, electronics, snacks, contact paths, and a direct handoff into the full app.",
  ...
  if(isEmpire){
    return {
      eyebrow:'Featured Phoenix pallet operations page',
      headline:'Empire Pallets landing page',
      copy:"A one-page Valley Verified landing built from Empire's live operations app: commercial pallet supply, recycled pallets, removal, drop trailer programs, heat-treatment support, custom pallets, quote intake, and a direct handoff into the full app.",
