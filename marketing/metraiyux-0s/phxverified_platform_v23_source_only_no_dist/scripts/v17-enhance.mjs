...
const SITE_URL = process.env.SITE_URL || 'https://phxverified.local';
...
const mutationServiceModel = {
  version:'17.0.0',
  generated_at:TODAY,
  purpose:'Backend-ready mutation service for PHX Verified action intake, policy enforcement, queueing, review decisions, state projection, event history, webhook outbox, replay, and exportable admin change-sets.',
...
const policyEngineModel = {
  ...
  role_lanes:{ admin_only:['suppression_request','suppression_apply','verification_decision','claim_status_update','listing_admin_patch','admin_review_decision'], ae_or_admin:['profile_enrichment','ae_note','ae_stage_update','owner_contact_log','lead_status_update'], public_queued:['lead_request','owner_claim','sponsor_intent'] }
};
