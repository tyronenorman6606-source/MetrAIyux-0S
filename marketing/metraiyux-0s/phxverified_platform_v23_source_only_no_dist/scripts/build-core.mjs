...
const SITE_URL = normalizeBaseUrl(process.env.SITE_URL || process.env.URL || 'https://valley-verified.pages.dev');
...
function normalizeBaseUrl(url){
  ...
  return /^https?:\/\//i.test(clean) ? clean : 'https://valley-verified.pages.dev';
}
...
function operatorPage(){
  ...
  return pageWrap({ title:'Operator Import Console | Valley Verified', description:'Operator import console for turning outside scrape exports into Valley Verified seed files.', canonical:`${SITE_URL}/operator/`, bodyClass:'operator-page' }, body, '<script type="module" src="/assets/operator.js"></script>');
}
