...
const adminConsoleModel = {
  version:'19.0.0', generated_at,
  purpose:'Browser-side operational console that calls runtime functions with upstream identity headers supplied by the host shell/reverse proxy or manual local test fields.',
  ...
  limitation:'Browser code cannot create trustworthy auth. The upstream SaaS shell must inject/authorize identity before production use.'
};
