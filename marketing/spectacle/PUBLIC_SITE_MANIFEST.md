# MetrAIyux 0S Public Overview Site Manifest
...
Public boundary: this site can describe the architecture and value. It does not publish the private implementation handoff, admin tutorials, customer records, or private operator runbooks.

Reference scans used: `metraiyux_0s_site`, SkyeSol style reference notes/assets, and the local design reference bundle.

Production public URL: https://metraiyux-0s-public-spectacle.pages.dev/

Full website target: https://metraiyux-0s-full-system.graylondonskyes.workers.dev/
