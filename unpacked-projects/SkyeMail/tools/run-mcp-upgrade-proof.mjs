...
async function main() {
  ...
  try {
    ...
    await callTool("repo_read", { path: "unpacked-projects/SkyeMail/index.html" });
    ...
    const effectAudit = await callTool("design_effect_audit", { source, requested: ["surfaceScreenshots"] });
    ...
    await callTool("design_recipe_plan", {
      ...
      goal: "prove live send receive and MCP upgrade",
      audience: "0S clients",
      effects: ["surfaceScreenshots"],
    });
    ...
    const proof = {
      ...
      logo_asset: "https://cdn1.sharemyimage.com/2026/02/16/logo1_transparent.png",
      ...
      public_pages: [
        "https://skymail-platform.graylondonskyes.workers.dev/marketing",
        "https://skymail-platform.graylondonskyes.workers.dev/live-proof",
        "https://skymail-platform.graylondonskyes.workers.dev/mcp-proof",
        "https://skymail-platform.graylondonskyes.workers.dev/suite",
        "https://skymail-platform.graylondonskyes.workers.dev/dashboard",
        "https://skymail-platform.graylondonskyes.workers.dev/compose",
      ],
    };
