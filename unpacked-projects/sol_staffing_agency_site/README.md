...
The proof was generated by `tools/record-sol-staffing-proof.mjs` against `/workspaces/MetrAIyux-0S/unpacked-projects/sol_staffing_agency_site`. It records employer intake, Skyegate FS27 auth, admin record creation, secure upload, protected brain route guardrail, and local SOL Brain response.
