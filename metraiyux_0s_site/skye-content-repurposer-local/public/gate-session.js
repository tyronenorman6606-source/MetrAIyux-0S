    ...
    overlay.innerHTML = `
      <div class="skye-content-gate-card">
        ...
        <label class="skye-content-gate-field">
          ...
          <input id="skyeContentGateToken" type="password" autocomplete="off" placeholder="Paste 0S / FS27 session token">
        </label>
        <div class="skye-content-gate-actions">
          <button class="primary" id="skyeContentGateUnlock" type="button">Unlock Free99 Session</button>
