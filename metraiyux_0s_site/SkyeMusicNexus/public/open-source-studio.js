...
(function () {
  ...
  const API = {
    studio: "/.netlify/functions/music-studio",
    assets: "/.netlify/functions/music-assets",
    releases: "/.netlify/functions/music-releases",
    exchange: "/.netlify/functions/music-exchange"
  };
