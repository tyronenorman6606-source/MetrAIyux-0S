...
exports.handler = async (event) => {
  try {
    ...
    const removeLabelIds = Array.isArray(body.removeLabelIds) ? body.removeLabelIds.map(String).filter(Boolean) : [];
    ...
    await gmailRequest(accessToken, '/messages/batchModify', {
      method: 'POST',
