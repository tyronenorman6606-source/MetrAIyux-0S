...
const { getHostedMailbox } = require("./_mailbox-provider");
  ...
  try{
    ...
    if(user.rsa_public_key_pem && user.version){
      ...
      inserted = await query(
        `insert into messages(
         ...
         values($1,$2,$3,$4,$5,$6,$7,'sent','resend',$8,'sent',now())
         returning id, created_at`,
        [user.id, `To: ${to}`, to, user.version, enc.encrypted_key_b64, enc.iv_b64, enc.ciphertext_b64, sendRes && sendRes.id ? sendRes.id : null]
      );
    }
    ...
    await mirrorPlatformEvent({
      ...
      meta: {
        ...
        subject,
        provider: "resend",
        provider_message_id: sendRes && sendRes.id ? sendRes.id : null,
