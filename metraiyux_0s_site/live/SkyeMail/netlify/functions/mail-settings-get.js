...
const { getHostedMailbox, listMailboxAliases } = require('./_mailbox-provider');
...
exports.handler = async (event) => {
  try {
    ...
    const hostedAliases = hostedMailbox ? await listMailboxAliases(auth.sub, hostedMailbox.id).catch(() => []) : [];
