...
- Live sovereign proof: the 2026-05-24 run sends two real messages through the active Citadel Database and SkyeNet mail lane and reads them back from the sovereign inbox. The public sanitized receipt is deployed at `https://skyemail-platform.graylondonskyes.workers.dev/proof/live-email-proof.json`.
