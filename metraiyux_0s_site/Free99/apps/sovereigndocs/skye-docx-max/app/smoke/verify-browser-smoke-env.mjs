...
const donorRoot = path.resolve(superIdeRoot, "..", "SuperIDEv2");
...
console.log(JSON.stringify({
  ...
  smoke_command: "SKYEDOCXMAX_SMOKE_URL=http://127.0.0.1:<local-dev-port>/index.html node smoke/smoke-standalone.mjs",
}, null, 2));
