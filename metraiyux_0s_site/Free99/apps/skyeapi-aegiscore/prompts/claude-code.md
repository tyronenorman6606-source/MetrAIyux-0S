# Claude Code task: integrate SkyeAPI into this repo
...
Claude Code-specific instruction: inspect the repo first, locate provider-specific calls, replace them with SkyeAPI SDK calls, then run the available tests/build commands. Keep a proof ledger.
