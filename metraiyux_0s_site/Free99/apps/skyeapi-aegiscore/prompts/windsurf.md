# Windsurf task: integrate SkyeAPI into this repo
...
Windsurf-specific instruction: operate in small verified edits, run checks after edits, and avoid broad rewrites unrelated to SkyeAPI integration.
