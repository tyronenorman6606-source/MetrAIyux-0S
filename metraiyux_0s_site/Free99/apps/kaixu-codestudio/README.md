...
This app still does not waste code on built-in auth. It accepts upstream claims through `x-kaixu-claims` or request JSON and enforces project access, roles, run permission, and approval behavior from those claims.
