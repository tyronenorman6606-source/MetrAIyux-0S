// Booking lane visual background mount. App behavior lives in fade-booking.js.

(function mountFadeMastersIntro() {
  const intro = document.querySelector('[data-fm-intro]');
  const enter = document.querySelector('[data-fm-enter-intro]');
  if (!intro) return;
  ...
  window.setTimeout(closeIntro, reduceMotion ? 500 : 3600);
})();
