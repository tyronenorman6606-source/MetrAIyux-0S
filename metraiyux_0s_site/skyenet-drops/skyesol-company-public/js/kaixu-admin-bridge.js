(function () {
  ...
  function mountGuardOverlay() {
    ...
    overlay.innerHTML = [
      ...
      '<a class="kaixu-founder-admin-guard__button" href="https://metraiyux-0s-full-system.graylondonskyes.workers.dev/admin/login.html?return=https%3A%2F%2Fskyenet.skyesol%2F">Open Gateway Admin</a>',
      '<a class="kaixu-founder-admin-guard__button kaixu-founder-admin-guard__button--ghost" href="https://metraiyux-0s-full-system.graylondonskyes.workers.dev/admin/login.html?return=https%3A%2F%2Fskyenet.skyesol%2F">Open Account</a>',
      '</div>',
      '</div>'
    ].join("");
