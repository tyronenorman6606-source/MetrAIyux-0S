...
try{
  ...
  const requiredHtml = ['login-form','signup-form','market-form','job-form','feed-form','provider-jobs','applicant-pool','contractor-feed','assignments','routes','roster','ratings','operator-assign-form','rating-form','house-jobs','payments','audits','workflow-board','workflow-timeline'];
