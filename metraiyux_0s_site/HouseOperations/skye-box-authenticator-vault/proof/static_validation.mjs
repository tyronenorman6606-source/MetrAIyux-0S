...
const externalCheckHtml = html
  .replace(/otpauth:\/\/totp/g, '')
  .replace(/https:\/\/skyegatefs27-citadeldb\.graylondonskyes\.workers\.dev\/pin-gate\.html/g, '');
if (/https?:\/\//i.test(externalCheckHtml)) throw new Error('Unexpected external http(s) reference in index.html');
