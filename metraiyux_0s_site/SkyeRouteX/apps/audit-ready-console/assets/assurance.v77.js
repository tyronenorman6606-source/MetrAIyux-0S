(function(){
  ...
  function renderShell(){
    ...
    if(activeMonth && activeMonth.title !== undefined){ activeMonth.title = 'Cached app records: ' + ((registry.apps || []).length || 0); }
  }
