(() => {
  ...
  function sessionPath() {
    return "/.netlify/functions/skygate-session";
  }
    ...
    overlay.innerHTML = `
      <div class="skye-media-gate-card">
        ...
        <label class="skye-media-gate-field">
          ...
          <input id="skyeMediaGateToken" type="password" autocomplete="off" placeholder="Paste 0S / FS27 / SkyGate session token">
        </label>
        <div class="skye-media-gate-actions">
          ...
          <button id="skyeMediaGateUnlock" type="button">Attach Gate Token</button>
