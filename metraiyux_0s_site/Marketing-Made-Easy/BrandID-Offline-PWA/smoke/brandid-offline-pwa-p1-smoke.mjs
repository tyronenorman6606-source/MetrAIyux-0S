...
for (const page of generatedPages) {
  if (true) {
    ...
    if (!html.includes('id="btnDownloadPrimary"')) failures.push(page + ' missing canonical BrandID export controls');
...
console.log('BrandID Offline PWA P1 fix smoke passed: ' + htmlPages.length + ' routes checked.');
