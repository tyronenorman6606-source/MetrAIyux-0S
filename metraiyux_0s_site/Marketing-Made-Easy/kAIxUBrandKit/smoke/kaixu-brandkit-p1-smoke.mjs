...
for (const page of generatedPages) {
  if (true) {
    ...
    if (!html.includes("kAIxU Studio")) failures.push(page + ' missing canonical BrandKit studio controls');
...
console.log('kAIxU BrandKit P1 fix smoke passed: ' + htmlPages.length + ' routes checked.');
