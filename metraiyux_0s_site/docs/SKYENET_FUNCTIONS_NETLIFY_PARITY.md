...
Remaining function-family targets:

- Build command capture and dependency install in a jailed builder.
...
The live parity proof now includes uploaded functions, scheduled/background metadata, source custody, Forms, console function-grant/rollback UI, and route stress. Latest production evidence on 2026-06-01:

- FS27 Worker version: `9bdd9b4c-7305-48a5-b5a6-54d82a210956`.
...
- Generated: `2026-06-01T00:59:56.814Z`.
- Result: `ok: true`, `functions_ok: true`, `function_invocation_status: 201`, source download `200`, private source bytes `24064`, failures `[]`.
...
- CLI function proof: `deploy.stdout_json.functions.uploaded: true`, `function_count: 5`, `server_signed: true`, runtime `cloudflare-dynamic-worker-v1`; bundled local helper function `with-helper` invoked at `/.netlify/functions/with-helper` with status `202` and a receipt header.
...
- Stress receipt: `test-artifacts/skyenet-netlify-parity-stress/skyenet-netlify-parity-stress-live-http-latest.json`, generated `2026-06-01T00:49:46.037Z`, `ok: true`, `3` fresh deployments, `36` read checks, failures `[]`. Stress deployment IDs: `dep_20260601005035`, `dep_20260601005539`, `dep_20260601010035`.
