...
import { getSkyePayClient, listSkyePayOffers, listSkyePayPlatformRoutes, publicSkyePayCopy } from "./_lib/skyepayCatalog.js";
import { publicSkyeMeritCatalog } from "./_lib/skyeMerit.js";
import { SKYPAY_REPO_STRIPE_OFFER_COUNT } from "./_lib/skyepayRepoStripeOffers.js";
...
export default wrap(async (req) => {
  ...
  return json(200, {
    ...
    skyemerit: publicSkyePayCopy(publicSkyeMeritCatalog()),
    client,
    offers: listSkyePayOffers(client),
    platform_routes: publicSkyePayCopy(listSkyePayPlatformRoutes())
  }, headers);
});
