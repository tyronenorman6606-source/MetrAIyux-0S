    ...
    overlay.innerHTML = `
      <div class="skye-split-gate-card">
        ...
        <label class="skye-split-gate-field">
          ...
          <input id="skyeSplitGateToken" type="password" autocomplete="off" placeholder="Paste 0S / FS27 session token">
        </label>
        <div class="skye-split-gate-actions">
          <button class="primary" id="skyeSplitGateUnlock" type="button">Unlock Free99 Session</button>
